  ...
  module.exports = XMLNode = (function() {
    function XMLNode(parent1) {
      ...
      if (!XMLElement) {
        ...
        XMLText = __nccwpck_require__(1318);
        XMLProcessingInstruction = __nccwpck_require__(6939);
        XMLDummy = __nccwpck_require__(2190);
        NodeType = __nccwpck_require__(9267);
...
// EXTERNAL MODULE: ./node_modules/sitemapper/lib/assets/sitemapper.js
var sitemapper = __nccwpck_require__(1278);
var sitemapper_default = /*#__PURE__*/__nccwpck_require__.n(sitemapper);
;// CONCATENATED MODULE: ./src/mapper.ts
var mapper_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
function parseSiteMapper(url) {
    return mapper_awaiter(this, void 0, void 0, function* () {
        const site = new (sitemapper_default())({ url });
...
main().catch(e => {
    (0,core.debug)(`error: ${JSON.stringify(e)}`);
    (0,core.debug)(e.stack);
